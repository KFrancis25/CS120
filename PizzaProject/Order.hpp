...
using namespace std;
#ifndef PIZZAPROJECT_ORDERS_HPP
#define PIZZAPROJECT_ORDERS_HPP
...
void Order::placeOrder(string address, Time timeOrdered, string order) {
    ...
    cout << "--------------------" << endl;
    cout << "Order for: " << orderInfo <<  " placed at: " << orderTime.toString() << endl << "To be delivered to: "
         << orderAddress << endl;
    cout << "--------------------" << endl;
...
void Order::Deliver( Time timeDelivered){
    ...
    int total_time = timeElapsed.elapsedMin(orderTime,timeDelivered);
    ...
    cout << "order took: " << total_time << " minutes in total" << endl;
    cout << "--------------------" << endl;
